...
namespace UnitTestSoulGlo
{
    ...
    public class UnitTestAuxCategoria
    {
        ...
        public void TestAgregarCategoriaComoObjeto()
        {
            ...
            categoriaTest.Idcategoria = 1;
            categoriaTest.Nombre = "Shampoo";
            categoriaTest.Descripcion = "El mejor shampoo del mundo";

            int resultadoEsperado = 1;
            int resultadoObtenido = 0;

            //ACT
            resultadoObtenido = auxCategoria.Agregar(categoriaTest);
        ...
        public void TestBuscar()
        {
            ...
            //ACT
            resultadoObtenido = auxCategoria.Buscar(idCategoria);
        ...
        [TestMethod]
        public void TestBuscarIdNoData(){
            //Arrange Buscar
            AuxCategoria auxCategoria = new AuxCategoria();
            int idCategoriaNoExistente = 99;
            ...
            //ACT
            resultadoObtenido = auxCategoria.Buscar(idCategoriaNoExistente);

            //Assert
            Assert.AreEqual(resultadoEsperado, resultadoObtenido);
        }
        #endregion pruebas a Buscar

        #region pruebas a Posicion
        ...
        public void TestPosicion()
        {
            ...
            //ACT
            resultadoObtenido = auxCategoria.Posicion(idCategoria);
        ...
        [TestMethod]
        public void TestPosicionIdNoData()
        {
            //Arrange Buscar
            AuxCategoria auxCategoria = new AuxCategoria();
            int idCategoriaNoExistente = 99;
            ...
            //ACT
            resultadoObtenido = auxCategoria.Posicion(idCategoriaNoExistente);
